...
public static class VerifiedBackupRestorer
{
        ...
        TimeSpan maximumReceiptAge)
    {
        ...
        {
            throw new Exact25FullBackupException("restore_receipt_invalid", "The signed exact-23 backup receipt is invalid.");
        }
    }
    ...
    : IVerifiedBackupEvidenceRestoreTarget
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new Exact25FullBackupException("restore_database_invalid", "The restore database is outside the exact-23 inventory.");
        }
