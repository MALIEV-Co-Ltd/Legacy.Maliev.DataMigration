    ...
    TimeProvider timeProvider)
{
    ...
    internal static void ValidateInventory(FreshSchemaPlan schema)
    {
        ...
        {
            throw new DeltaPlanException("delta_plan_schema_fingerprint_stale",
                "The schema plan was generated by a different runner fingerprint implementation; rebuild and regenerate it before reading rows.");
        }
    }
}
