...
public static partial class ReviewedExecutionAuthorizationProducer
{
        ...
        DateTimeOffset nowUtc)
    {
        ...
        {
            throw Error("authorization_backup_receipt_invalid", "The signed exact-25 backup receipt is invalid or stale.");
        }
...
public static partial class ReviewedMigrationProvenanceProducer
{
        ...
        DateTimeOffset nowUtc)
    {
        ...
        {
            throw Error("provenance_execution_invalid", "A completed exact-25 migration result is required.");
        }
        ...
        {
            throw Error("provenance_backup_receipt_invalid", "The signed exact-25 backup receipt is invalid or stale.");
        }
