...
{
    [Fact]
    public void BuildStartInfo_UsesDeterministicPlainDumpAndKeepsCredentialsOutOfArguments()
    {
        ...
        Assert.Contains("--format=plain", start.ArgumentList);
        Assert.Contains("--restrict-key", start.ArgumentList);
